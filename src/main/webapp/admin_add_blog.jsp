...
<div class="container ">
    <div class="row - mt-5"> </div>
            <div class="bg-light text-dark rounded p-5">
                <form action="admin-add-blog-servlet" method = "post" class="justify-content-center">
                    <div class="mb-3">
                        <p style="font-size:40px;">Blog Ekle</p>

                        <%
                            Object error = request.getAttribute("insertBlogError");
                            if(error != null){
                    ...
                    <div class="mb-3">
                        <input type ="text" class="form-control" name="type" placeholder="Tür" required>
                    </div>


                    <div class="mb-3">
                        <textarea class="form-control" name="text" rows="10" placeholder="Detay" required></textarea>
                    </div>
