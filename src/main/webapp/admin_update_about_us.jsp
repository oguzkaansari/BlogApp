  ...
  <div class="row - mt-5" >
    <div class="row - mt-5">
      <div class="bg-light text-dark rounded p-5">
        <form action="admin-update-about-us-servlet" method = "post" class="justify-content-center">
          <div class="mb-3">
            <p style="font-size:40px;">Hakkımzıda Bilgisini Düzenle</p>
          ...
          <div class="mb-3">
            <textarea class="form-control" name="text_area" rows="10" placeholder="Detay" required><%=text%></textarea>
          </div>
