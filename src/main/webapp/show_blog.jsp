...
<div class="container ">
    <div class="row - mt-5" >
        <div style="padding: unset">
            ...
            <a href="admin-update-blog-servlet?bid=<%=blog.getId()%>" class="btn btn-warning btn-sn" style="float: right; margin: fill">
                Düzenle
        ...
        <div class="row - mt-5">
            <div class="bg-light text-dark rounded p-5">
                <div class="mb-3">
                    <label style="font-size:30px;"><%=blog.getTitle()%></label>
                </div>

                <div class="mb-3">
                    <label type ="text">Tür : <%=blog.getType()%></label>
                </div>
